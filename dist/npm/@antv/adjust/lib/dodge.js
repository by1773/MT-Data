...
var Adjust = require("./base.js");

var each = require("../../util/lib/each.js");

var MARGIN_RATIO = 0.5;
var DODGE_RATIO = 0.5;
...
function (_Adjust) {
  ...
  _proto.getDodgeOffset = function getDodgeOffset(range, index, count) {
    ...
    var offset = 0.5 * (tickLength - count * width - (count - 1) * margin) + ((index + 1) * width + index * margin) - 0.5 * width - 0.5 * tickLength;
