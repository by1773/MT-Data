...
var isArray = require("../../util/lib/type/is-array.js");

var isNil = require("../../util/lib/type/is-nil.js");

var mix = require("../../util/lib/mix.js");
  ...
  function AttributeBase(cfg) {
    ...
    if (cfg.callback) {
      ...
      mixedCallback = function mixedCallback() {
        ...
        var ret = userCallback.apply(undefined, params);
